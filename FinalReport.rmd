...
The type of variables in this problem is one that consist of Race and Capital Puishnishment(cappun), both of these are catagorical variables,but because of the different types of the variables, the cat cat helper file will be the choice of data help 
